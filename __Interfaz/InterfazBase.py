...
Versión de Python: 3.7.2
____________________________________
Hints: Verifique que el auto encendió correctamente.
Verifique que tanto el equipo de telemetría como el auto estén
conectados a la misma red inalámbrica.
Utilice las teclas WASD para mover el auto, seleccione un piloto
e inicie su Test Drive.
"""
...
def about_window():
    ...
    Info = scrolledtext.ScrolledText(About,width= 40, height= 10) #no son pixeles hee hee
    Info.insert(INSERT,AboutText)
    Info.place(x = 600, y = 300)
